...
<script type="text/javascript">
   $(function() {
      ...
      nhn.husky.EZCreator.createInIFrame({//iframe을 만들어주는 명령어
         oAppRef : editor_object,
         elPlaceHolder : "smt",//적용대상 태그의 이름
         sSkinURI : "../smarteditor/SmartEditor2Skin.html",//스마트에디터 이미지경로
         htParams : {
            bUseToolbar : true,
      ...
      $("button").click(function() {
         editor_object.getById["smt"].exec("UPDATE_CONTENTS_FIELD",[]);//입력한내용을 text area에 적용
